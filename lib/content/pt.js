...
const C = {
  ui: {
    ...
    verifier: {
      ...
      gameHash: 'Hash do jogo — hash do resultado da rodada',
      gameHashPh: 'o hash da rodada, ex.: 0a1b2c… (hex)',
      salt: 'Salt (opcional)',
      saltPh: 'salt público, se o seu cassino aplica HMAC ao hash',
  ...
  games: {
    ...
    crash: {
      name: 'Crash', resultLabel: 'Multiplicador', tagline: 'O multiplicador de crash da rodada, a partir do hash do jogo.',
      intro: 'Crash é multijogador: um único multiplicador compartilhado por rodada, derivado do hash daquela rodada — não da sua server seed e nonce pessoais. O Faircheck recalcula o ponto de crash exato a partir do hash que o cassino publicou, com o house edge exposto.',
      howItWorks: [
        'Antes da rodada, o cassino se compromete com um hash; quando a rodada termina, esse hash (sua posição em uma cadeia de hashes pública) é revelado.',
        'Uma fatia de 13 dígitos hexadecimais do hash vira um inteiro h, e o ponto de crash é floor((100·2^52 − h) / (2^52 − h)) / 100.',
        'Uma pequena fração das rodadas — cerca do house edge, ex.: 1 em 101 a 1% — estoura instantaneamente em 1.00×; é aí que mora o house edge.',
      ],
      faq: [
        ['Por que um hash do jogo, e não server seed e nonce?', 'Crash é um único jogo compartilhado por todos na rodada, então não pode depender da client seed de nenhum jogador específico. Toda a rodada é fixada por um único hash com o qual o cassino se compromete de antemão.'],
        ['Meu cassino usa um salt — o que é isso?', 'Alguns operadores aplicam HMAC ao hash da rodada com um salt público (muitas vezes um futuro hash de bloco do Bitcoin) antes de calcular o multiplicador. Cole-o no campo Salt opcional; do contrário, deixe-o vazio.'],
      ],
      note: 'Atenção: o Crash embute o house edge da {casino} na fórmula por meio de uma chance de estouro instantâneo. Se o seu resultado estiver errado, defina o house edge no valor do seu cassino (1% é o padrão).',
    },
  },
